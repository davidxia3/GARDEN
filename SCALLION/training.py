...
image_directory = 'SCALLION/sampled_images'
mask_directory = 'SCALLION/processed_masks'
SIZE = 256

image_names = glob.glob("WIP/sampled_images/*.png")
image_names.sort()
images = [cv2.imread(img, 0) for img in image_names]
image_dataset = np.array(images)
image_dataset = np.expand_dims(image_dataset, axis=3)

mask_names = glob.glob("WIP/processed_masks/*.png")
mask_names.sort()
...
model.save('SCALLION/models/v5_lr-34_bs-32_epoch-75.hdf5')
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('SCALLION/loss_graph5.png')
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('SCALLION/accuracy_graph5.png')