...
mask_dir = "SCALLION/automatic_masks/v5"
...
for image_filename in images:
    ...
    mask_path = os.path.join(mask_dir, "mask_" + image_filename)
    output_path = os.path.join("SCALLION/cutouts/v5", "cutout_" + image_filename[0:-4] + ".png")
