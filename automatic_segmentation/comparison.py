...
# Directories containing input images and masks from three different models
input_dir = 'automatic_segmentation/all_images'
mask_dir_1 = 'automatic_segmentation/v1_masks'
mask_dir_2 = 'automatic_segmentation/v2_masks'
mask_dir_3 = 'automatic_segmentation/v3_masks'

# Directory to save the comparison images
output_dir = 'automatic_segmentation/comparison_images'
...
def compare_images(image, mask1, mask2, mask3, output_path):
    """Create a comparison plot of the original image and three masks."""
