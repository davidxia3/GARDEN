...
image_directory = 'manual_segmentation/images'
mask_directory = 'manual_segmentation/processed_masks'
SIZE = 256

image_names = glob.glob("manual_segmentation/images/*.jpg")
image_names.sort()
images = [cv2.imread(img, 0) for img in image_names]
image_dataset = np.array(images)
image_dataset = np.expand_dims(image_dataset, axis=3)

mask_names = glob.glob("manual_segmentation/processed_masks/*.png")
mask_names.sort()
...
model.save('automatic_segmentation/v3_epoch-50.hdf5')
