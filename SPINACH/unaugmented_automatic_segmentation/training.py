...
image_directory = 'SPINACH/manual_segmentation/unaugmented_images'
mask_directory = 'SPINACH/manual_segmentation/unaugmented_processed_masks'
SIZE = 256

image_names = glob.glob("SPINACH/manual_segmentation/unaugmented_images/*.jpg")
image_names.sort()
images = [cv2.imread(img, 0) for img in image_names]
image_dataset = np.array(images)
image_dataset = np.expand_dims(image_dataset, axis=3)

mask_names = glob.glob("SPINACH/manual_segmentation/unaugmented_processed_masks/*.png")
mask_names.sort()
...
model.save('SPINACH/unaugmented_automatic_segmentation/models/v8u_lr3-4_bs-32.hdf5')
