...
image_directories = ['SPINACH/automatic_segmentation/cutouts/v3_cutouts']
layers = [2]
dropouts = [0.8,0.9,0.95]
optimizers = ['adam']
batch_sizes = [128]
epochs = [15,20]
...
create_html(df, 'LETTTUCE/augmented_models/performance/performance_.html')
